...
#endif
  // clang-format on
  cerr << R"(Applies a series of isostere-like reactions to a set of molecules.
  -R <fname>    file with list of reactions.  textproto reactions are prefixed with PROTO:.
