...
//#endif
  ...
  py::class_<dicer_api::Dicer>(m, "Dicer")
    ...
    .def("set_break_cc_bonds_at_highly_connected", &dicer_api::Dicer::set_break_cc_bonds_at_highly_connected, "C-[CD>2] bonds are to be broken")
    .def("set_label_join_points", &dicer_api::Dicer::set_label_join_points, "Isotope for join points")
    .def("set_increment_isotope_for_join_points", &dicer_api::Dicer::set_increment_isotope_for_join_points, "Isotopes for join points added to any existing isotopic value")
